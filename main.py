...
if __name__ == "__main__":
    ...
    # 🔧 将整个 elif config.task_type.lower() == 'hyperparameter': 块替换为：
    elif config.task_type.lower() == 'hyperparameter':
        """超参数优化 - 使用模块化的Optuna优化器"""
        
        # 创建优化器实例
        optimizer = OptunaHyperparameterOptimizer(config, train)
        ...
        print("🎉 超参数优化完成！")
        print("📊 查看可视化结果:")
        print(f"   - 打开 {config.output_dir}/visualizations/ 目录")
        print("   - 用浏览器打开 .html 文件查看图表")
